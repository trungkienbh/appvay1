            ...
            <div class="indexBox">
                ...
                <ul>
                    <table width="100%" border="0" cellspacing="0" cellpadding="7" class="tableBasic">
                        <tr>
                            <td width="120" bgcolor="#FFFFFF">PHP 版本：</td>
                            <td bgcolor="#FFFFFF"><strong> 
                          <?php echo PHP_VERSION; ?> </strong></td>
                            <td width="100" bgcolor="#FFFFFF">Base版本：</td>
                            <td bgcolor="#FFFFFF"><strong> v
                          <?php echo THINK_VERSION; ?> </strong></td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF">缓存目录：</td>
                            <td bgcolor="#FFFFFF"><strong> 
                          <?php echo TEMP_PATH; ?> </strong></td>
                            <td bgcolor="#FFFFFF">系统语言：</td>
                            <td bgcolor="#FFFFFF"><strong>zh_cn</strong></td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF">调试模式：</td>
                            <td bgcolor="#FFFFFF"><strong> 
                          <?php if(APP_DEBUG)echo '是';else echo '否'; ?> </strong></td>
                            <td bgcolor="#FFFFFF">当前IP：</td>
                            <td bgcolor="#FFFFFF"><strong> 
                          <?php echo get_client_ip(); ?> </strong></td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF">内存统计支持：</td>
                            <td bgcolor="#FFFFFF"><strong> 
                          <?php echo MEMORY_LIMIT_ON; ?> </strong></td>
                            <td bgcolor="#FFFFFF">编码：</td>
                            <td bgcolor="#FFFFFF"><strong>UTF-8</strong></td>
                        </tr>
                        <tr>
                            <td bgcolor="#FFFFFF">SLJD-cms版本：</td>
                            <td bgcolor="#FFFFFF"><strong>v<?php echo C('install_vis');?></strong></td>
                            <td bgcolor="#FFFFFF">安装日期：</td>
                            <td bgcolor="#FFFFFF"><strong> 2018/06/22 19:23:12</strong></td>
                        </tr>
                  </table>
                </ul>
            </div>
    ...
    <ul>
        <table width="100%" border="0" cellspacing="0" cellpadding="7" class="tableBasic">
            ...
            <tr>
                ...
                <td valign="top"><?php echo get_cfg_var("upload_max_filesize")?get_cfg_var("upload_max_filesize"):"不允许上传附件"; ?></td>
